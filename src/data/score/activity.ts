...
const entries: ActivityEntry[] = [
  ...
  {
    id: ActivityIdType.VoLessonDa,
    label: 'score.activity.vo_lesson_da',
    color: 'bg-red-700 text-white',
    actions: [ActionIdType.SpLessonVo],
  },
  {
    id: ActivityIdType.VoLessonVi,
    label: 'score.activity.vo_lesson_vi',
    color: 'bg-red-700 text-white',
    actions: [ActionIdType.SpLessonVo],
  },
  {
    id: ActivityIdType.DaLessonVo,
    label: 'score.activity.da_lesson_vo',
    color: 'bg-blue-700 text-white',
    actions: [ActionIdType.SpLessonDa],
  },
  {
    id: ActivityIdType.DaLessonVi,
    label: 'score.activity.da_lesson_vi',
    color: 'bg-blue-700 text-white',
    actions: [ActionIdType.SpLessonDa],
  },
  {
    id: ActivityIdType.ViLessonVo,
    label: 'score.activity.vi_lesson_vo',
    color: 'bg-yellow-500 text-yellow-900',
    actions: [ActionIdType.SpLessonVi],
  },
  {
    id: ActivityIdType.ViLessonDa,
    label: 'score.activity.vi_lesson_da',
    color: 'bg-yellow-500 text-yellow-900',
    actions: [ActionIdType.SpLessonVi],
  },
  {
  ...
  {
    id: ActivityIdType.ClassVo,
    label: 'score.activity.class_vo',
    color: 'bg-indigo-700 text-white',
    actions: [ActionIdType.ClassWork],
  },
  {
    id: ActivityIdType.ClassDa,
    label: 'score.activity.class_da',
    color: 'bg-indigo-700 text-white',
    actions: [ActionIdType.ClassWork],
  },
  {
    id: ActivityIdType.ClassVi,
    label: 'score.activity.class_vi',
    color: 'bg-indigo-700 text-white',
    actions: [ActionIdType.ClassWork],
  },
  {
