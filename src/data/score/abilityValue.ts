...
const stageData = {
  [RarityTierType.SSR]: {
    ...
    [AbilityNameKeyType.LessonBonus]: ['6.5%', '7.0%', '7.5%', '8.0%', '8.5%'],
  ...
  [RarityTierType.SR]: {
    ...
    [AbilityNameKeyType.LessonBonus]: ['4.4%', '4.9%', '5.4%', '5.9%', '6.4%'],
  ...
  [RarityTierType.R]: {
    ...
    [AbilityNameKeyType.LessonBonus]: ['2.8%', '3.2%', '3.6%', '4.0%', '4.3%'],
