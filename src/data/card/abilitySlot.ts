...
export const ABILITY_MAX_COUNT: Partial<Record<AbilityNameKeyType, number>> = {
  ...
  [AbilityNameKeyType.DeleteCount]: 4,
  [AbilityNameKeyType.VitalityCardAcquire8]: 4,
  [AbilityNameKeyType.GoodConditionCardAcquire8]: 4,
  [AbilityNameKeyType.ConcentrationCardAcquire8]: 4,
  [AbilityNameKeyType.GoodImpressionCardAcquire8]: 4,
  [AbilityNameKeyType.MotivationCardAcquire8]: 4,
